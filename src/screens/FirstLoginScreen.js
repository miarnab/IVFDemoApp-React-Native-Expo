...
export default function FirstLoginScreen({navigation}){
    ...
    return(
        <Stack style={styles.upperContainer} spacing={20}>
            ...
            <Stack m={4} spacing={8}>
            <TextInput label='PHONE NUMBER' variant='standard' style={styles.textinput}/>
            <Button title="USE OTP TO LOGIN" color='lightblue' pressEffectColor='lightblue' onPress={() => navigation.navigate('Dashboard')}/>
            </Stack>
            <Stack style={styles.textOR}>
            <Text> - OR - </Text>
            </Stack>
            <Stack m={4} spacing={8}>
            <Button variant="outlined" title="Continue with Username" color='lightblue' pressEffectColor='lightblue' onPress={()=> navigation.navigate('UsernameLogin')}/>
            </Stack>
            <Stack style={styles.textOR}>
